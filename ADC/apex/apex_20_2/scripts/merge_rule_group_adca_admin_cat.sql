...
begin
  ...
  adc_admin.merge_rule_group(
    p_crg_id => adc_admin.map_id(1008),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 2,
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1010),
    p_cru_crg_id => adc_admin.map_id(1008),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1012),
    p_cra_cru_id => adc_admin.map_id(1010),
    p_cra_crg_id => adc_admin.map_id(1008),
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1014),
    p_cru_crg_id => adc_admin.map_id(1008),
  ...
  adc_admin.merge_rule_action(
    ...
    p_cra_cru_id => adc_admin.map_id(1014),
    p_cra_crg_id => adc_admin.map_id(1008),
    p_cra_cpi_id => 'R2_ACTION_TYPE',
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(1008));
