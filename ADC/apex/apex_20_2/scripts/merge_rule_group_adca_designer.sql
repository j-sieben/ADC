...
begin
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(767),
    p_cru_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(769),
    p_cra_cru_id => adc_admin.map_id(767),
    p_cra_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(779),
    p_cra_cru_id => adc_admin.map_id(777),
    p_cra_crg_id => adc_admin.map_id(765),
    p_cra_cpi_id => 'DOCUMENT',
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(783),
    p_cra_cru_id => adc_admin.map_id(781),
    p_cra_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(787),
    p_cra_cru_id => adc_admin.map_id(785),
    p_cra_crg_id => adc_admin.map_id(765),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(791),
    p_cra_cru_id => adc_admin.map_id(789),
    p_cra_crg_id => adc_admin.map_id(765),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(795),
    p_cra_cru_id => adc_admin.map_id(793),
    p_cra_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(799),
    p_cra_cru_id => adc_admin.map_id(797),
    p_cra_crg_id => adc_admin.map_id(765),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
  ...
  adc_admin.merge_apex_action(    
    p_caa_id => adc_admin.map_id(801),
    p_caa_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_apex_action_item(
    p_caai_caa_id => adc_admin.map_id(801),
    p_caai_cpi_crg_id => adc_admin.map_id(765),
    p_caai_cpi_id => 'B13_CANCEL',
    p_caai_active => adc_util.C_TRUE);


  adc_admin.merge_apex_action(    
    p_caa_id => adc_admin.map_id(803),
    p_caa_crg_id => adc_admin.map_id(765),
    p_caa_caat_id => 'ACTION',
  ...
  adc_admin.merge_apex_action_item(
    p_caai_caa_id => adc_admin.map_id(803),
    p_caai_cpi_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_apex_action_item(
    p_caai_caa_id => adc_admin.map_id(805),
    p_caai_cpi_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_apex_action_item(
    p_caai_caa_id => adc_admin.map_id(809),
    p_caai_cpi_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.merge_apex_action_item(
    p_caai_caa_id => adc_admin.map_id(811),
    p_caai_cpi_crg_id => adc_admin.map_id(765),
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(765));
