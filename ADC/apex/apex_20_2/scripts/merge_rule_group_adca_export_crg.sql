...
begin
  ...
  adc_admin.merge_rule_group(
    p_crg_id => adc_admin.map_id(1108),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 8,
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1110),
    p_cru_crg_id => adc_admin.map_id(1108),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1112),
    p_cra_cru_id => adc_admin.map_id(1110),
    p_cra_crg_id => adc_admin.map_id(1108),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1114),
    p_cra_cru_id => adc_admin.map_id(1110),
    p_cra_crg_id => adc_admin.map_id(1108),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1116),
    p_cru_crg_id => adc_admin.map_id(1108),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1118),
    p_cra_cru_id => adc_admin.map_id(1116),
    p_cra_crg_id => adc_admin.map_id(1108),
  ...
  adc_admin.merge_apex_action(
    p_caa_id => adc_admin.map_id(1120),
    p_caa_crg_id => adc_admin.map_id(1108),
  ...
  adc_admin.merge_apex_action_item(
    p_caai_caa_id => adc_admin.map_id(1120),
    p_caai_cpi_crg_id => adc_admin.map_id(1108),
    p_caai_cpi_id => 'B8_EXPORT',
    p_caai_active => adc_util.C_TRUE);



  adc_admin.propagate_rule_change(adc_admin.map_id(1108));
