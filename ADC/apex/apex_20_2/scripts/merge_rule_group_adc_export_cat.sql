...
begin
  ...
  adc_admin.merge_rule(
    ...
    p_cru_cgr_id => adc_admin.map_id(51),
  ...
  adc_admin.merge_rule_action(
    ...
    p_cra_cgr_id => adc_admin.map_id(51),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(61),
    p_cra_cru_id => adc_admin.map_id(59),
    p_cra_cgr_id => adc_admin.map_id(51),
    p_cra_cpi_id => 'B12_EXPORT',
    p_cra_cat_id => 'SET_VISUAL_STATE',
    p_cra_param_1 => q'|SHOW_DISABLE|',
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(65),
    p_cra_cru_id => adc_admin.map_id(63),
    p_cra_cgr_id => adc_admin.map_id(51),
    p_cra_cpi_id => 'B12_EXPORT',
    p_cra_cat_id => 'SET_VISUAL_STATE',
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(51));
