...
begin
  ...
  adc_admin.merge_rule(
    ...
    p_cru_cgr_id => adc_admin.map_id(37),
  ...
  adc_admin.merge_rule_action(
    ...
    p_cra_cgr_id => adc_admin.map_id(37),
  ...
  adc_admin.merge_apex_action(    
    p_caa_id => adc_admin.map_id(49),
    p_caa_cgr_id => adc_admin.map_id(37),
    p_caa_cty_id => 'ACTION',
  ...
  adc_admin.merge_apex_action_item(
    p_cai_caa_id => adc_admin.map_id(49),
    p_cai_cpi_cgr_id => adc_admin.map_id(37),
    p_cai_cpi_id => 'B8_EXPORT',
    p_cai_active => adc_util.C_TRUE);



  adc_admin.propagate_rule_change(adc_admin.map_id(37));
