...
begin
  ...
  adc_admin.merge_rule_group(
    p_crg_id => adc_admin.map_id(1068),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 5,
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1070),
    p_cru_crg_id => adc_admin.map_id(1068),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1072),
    p_cra_cru_id => adc_admin.map_id(1070),
    p_cra_crg_id => adc_admin.map_id(1068),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1074),
    p_cra_cru_id => adc_admin.map_id(1070),
    p_cra_crg_id => adc_admin.map_id(1068),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1076),
    p_cra_cru_id => adc_admin.map_id(1070),
    p_cra_crg_id => adc_admin.map_id(1068),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1078),
    p_cru_crg_id => adc_admin.map_id(1068),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1080),
    p_cra_cru_id => adc_admin.map_id(1078),
    p_cra_crg_id => adc_admin.map_id(1068),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1082),
    p_cru_crg_id => adc_admin.map_id(1068),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1084),
    p_cra_cru_id => adc_admin.map_id(1082),
    p_cra_crg_id => adc_admin.map_id(1068),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
    p_cra_param_1 => q'|adca_ui.handle_capvt_changed;|',
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(1068));
