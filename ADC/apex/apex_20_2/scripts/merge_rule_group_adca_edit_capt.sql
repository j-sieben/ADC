...
begin
  ...
  adc_admin.merge_rule_group(
    p_crg_id => adc_admin.map_id(1205),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 5,
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1207),
    p_cru_crg_id => adc_admin.map_id(1205),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1209),
    p_cra_cru_id => adc_admin.map_id(1207),
    p_cra_crg_id => adc_admin.map_id(1205),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1211),
    p_cra_cru_id => adc_admin.map_id(1207),
    p_cra_crg_id => adc_admin.map_id(1205),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1213),
    p_cra_cru_id => adc_admin.map_id(1207),
    p_cra_crg_id => adc_admin.map_id(1205),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1215),
    p_cru_crg_id => adc_admin.map_id(1205),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1217),
    p_cra_cru_id => adc_admin.map_id(1215),
    p_cra_crg_id => adc_admin.map_id(1205),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1219),
    p_cru_crg_id => adc_admin.map_id(1205),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1221),
    p_cra_cru_id => adc_admin.map_id(1219),
    p_cra_crg_id => adc_admin.map_id(1205),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
    p_cra_param_1 => q'|adca_ui.handle_capvt_changed;|',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1223),
    p_cra_cru_id => adc_admin.map_id(1219),
    p_cra_crg_id => adc_admin.map_id(1205),
    p_cra_cpi_id => 'P5_CAPT_ID',
    p_cra_cat_id => 'SET_VISUAL_STATE',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(1225),
    p_cru_crg_id => adc_admin.map_id(1205),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(1227),
    p_cra_cru_id => adc_admin.map_id(1225),
    p_cra_crg_id => adc_admin.map_id(1205),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'IS_MANDATORY',
    p_cra_param_1 => q'||',
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(1205));
