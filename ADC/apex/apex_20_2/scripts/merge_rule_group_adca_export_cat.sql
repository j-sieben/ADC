...
begin
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(1098),
    p_cra_cru_id => adc_config.map_id(1094),
    p_cra_crg_id => adc_config.map_id(1092),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(1100),
    p_cru_crg_id => adc_config.map_id(1092),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(1102),
    p_cra_cru_id => adc_config.map_id(1100),
    p_cra_crg_id => adc_config.map_id(1092),
    p_cra_cpi_id => 'B12_EXPORT',
    p_cra_cat_id => 'SET_VISUAL_STATE',
    p_cra_param_1 => q'|SHOW_DISABLE|',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(1104),
    p_cru_crg_id => adc_config.map_id(1092),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(1106),
    p_cra_cru_id => adc_config.map_id(1104),
    p_cra_crg_id => adc_config.map_id(1092),
    p_cra_cpi_id => 'B12_EXPORT',
    p_cra_cat_id => 'SET_VISUAL_STATE',
