...
using (select 'CRU' amda_aldm_id, 'show' amda_alda_id, 'Rule selected from hierarchy' amda_comment, 'CRU_ID' amda_id_value, adc_util.C_TRUE amda_remember_page_state, 
        ...
        select 'CAA', 'update-action', 'Page Command saved', 'CAA_ID', adc_util.C_TRUE, adc_util.C_FALSE, null, adc_util.C_TRUE, adc_util.C_TRUE, 'CAA', 'CAG', adc_util.C_TRUE, 'CAG' from dual) s
