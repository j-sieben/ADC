...
begin
  ...
  adc_admin.merge_rule_group(
    p_crg_id => adc_admin.map_id(3527),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 12,
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(3529),
    p_cru_crg_id => adc_admin.map_id(3527),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3531),
    p_cra_cru_id => adc_admin.map_id(3529),
    p_cra_crg_id => adc_admin.map_id(3527),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3533),
    p_cra_cru_id => adc_admin.map_id(3529),
    p_cra_crg_id => adc_admin.map_id(3527),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(3535),
    p_cru_crg_id => adc_admin.map_id(3527),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3537),
    p_cra_cru_id => adc_admin.map_id(3535),
    p_cra_crg_id => adc_admin.map_id(3527),
    p_cra_cpi_id => 'B12_EXPORT',
    p_cra_cat_id => 'SET_VISUAL_STATE',
    p_cra_param_1 => q'|SHOW_DISABLE|',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(3539),
    p_cru_crg_id => adc_admin.map_id(3527),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3541),
    p_cra_cru_id => adc_admin.map_id(3539),
    p_cra_crg_id => adc_admin.map_id(3527),
    p_cra_cpi_id => 'B12_EXPORT',
    p_cra_cat_id => 'SET_VISUAL_STATE',
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(3527));
