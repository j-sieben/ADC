...
begin
  ...
  adc_admin.merge_rule_group(
    p_crg_id => adc_admin.map_id(3503),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 5,
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(3505),
    p_cru_crg_id => adc_admin.map_id(3503),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3507),
    p_cra_cru_id => adc_admin.map_id(3505),
    p_cra_crg_id => adc_admin.map_id(3503),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3509),
    p_cra_cru_id => adc_admin.map_id(3505),
    p_cra_crg_id => adc_admin.map_id(3503),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3511),
    p_cra_cru_id => adc_admin.map_id(3505),
    p_cra_crg_id => adc_admin.map_id(3503),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(3513),
    p_cru_crg_id => adc_admin.map_id(3503),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3515),
    p_cra_cru_id => adc_admin.map_id(3513),
    p_cra_crg_id => adc_admin.map_id(3503),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(3517),
    p_cru_crg_id => adc_admin.map_id(3503),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3519),
    p_cra_cru_id => adc_admin.map_id(3517),
    p_cra_crg_id => adc_admin.map_id(3503),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
    p_cra_param_1 => q'|adca_ui.handle_capvt_changed;|',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3521),
    p_cra_cru_id => adc_admin.map_id(3517),
    p_cra_crg_id => adc_admin.map_id(3503),
    p_cra_cpi_id => 'P5_CAPT_ID',
    p_cra_cat_id => 'SET_VISUAL_STATE',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(3523),
    p_cru_crg_id => adc_admin.map_id(3503),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(3525),
    p_cra_cru_id => adc_admin.map_id(3523),
    p_cra_crg_id => adc_admin.map_id(3503),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'IS_MANDATORY',
    p_cra_param_1 => q'||',
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(3503));
