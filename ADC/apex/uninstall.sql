  ...
  cursor delete_object_cur is
          select object_name name, object_type type
           ...
           where object_name in (
                 ...
                 'ADCA_UI_LOV_APEX_ACTION', 'ADCA_UI_LOV_APEX_ACTION_ITEMS', 'ADCA_UI_LOV_APEX_ACTION_TYPE', 'ADCA_UI_LOV_APPLICATIONS', 
                 ...
                 'ADCA_UI_LOV_PAGE_ITEM_TYPE', 'ADCA_UI_LOV_PAGE_ITEM_TYPE_GROUP', 'ADCA_UI_LOV_PIT_MESSAGE',
                 'ADCA_UI_LOV_YES_NO', 'ADCA_UI_LIST_PAGE_ITEMS', -- Views
                 'ADCA_LU_DESIGNER_ACTIONS', 'ADCA_LU_DESIGNER_MODES', 'ADCA_MAP_DESIGNER_ACTIONS', 'ADCA_MAP_FORM_ITEMS',  -- Tabellen
                 '',  -- Synonyme
                 '' -- Sequenzen
                 )
