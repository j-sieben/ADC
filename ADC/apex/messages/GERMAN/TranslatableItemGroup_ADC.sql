...
^'
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Registiert einen APEXAfterRefresh-Eventhandler. Wird das Ereignis ausgelöst, wird dies an ADC gemeldet und kann mit einer Regel AFTER_REFRESH = 1 gefangen werden.<br>Auslösendes Element ist das Element, dass in dieser Aktion als FIRING_ITEM registriert wird.</p>^'
  );
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Registiert einen APEXAfterDialogClose-Eventhandler.<br>Wird das Ereignis ausgel&ouml;st, wird dies an ADC gemeldet und kann mit einer Regel DIALOG_CLOSED = 1 gefangen werden.</br>Ausl&ouml;sendes Element ist das Element, dass in dieser Aktion als FIRING_ITEM registriert wird.</p>^'
  );
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Registiert einen DoubleClick-Eventhandler.<br>Wird das Ereignis ausgel&ouml;st, wird dies an ADC gemeldet und kann mit einer Regel DOUBLE_CLICK = 1 gefangen werden. <br>Ausl&ouml;sendes Element ist das Element, dass in dieser Aktion als FIRING_ITEM registriert wird.</p>^'
  );
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_display_name => q'^^',
    p_pti_description => q'^<p>Registiert einen Enter-Taste-Eventhandler.<br>Wird das Ereignis ausgelöst, wird dies an ADC gemeldet und kann mit einer RegelENTER_KEY = 1 gefangen werden.<br>Auslösendes Element ist das Element, dass in dieser Aktion als FIRING_ITEM registriert wird.</p>^'
  );
...
^'
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_pml_name => q'^GERMAN^',
    p_pti_pmg_name => q'^ADC^',
    p_pti_name => q'^ADC-Regel(n) exportieren^',
    p_pti_display_name => q'^^',
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_pml_name => q'^GERMAN^',
    p_pti_pmg_name => q'^ADC^',
    p_pti_name => q'^Regel erzeugen^',
    p_pti_display_name => q'^^',
    p_pti_description => q'^Ruft Seite EDIT_CRU auf^'
  );
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_pml_name => q'^GERMAN^',
    p_pti_pmg_name => q'^ADC^',
    p_pti_name => q'^Regelgruppe erstellen^',
    p_pti_display_name => q'^^',
    p_pti_description => q'^^'
  );
  ...
  pit_admin.merge_translatable_item(
    ...
    p_pti_pml_name => q'^GERMAN^',
    p_pti_pmg_name => q'^ADC^',
    p_pti_name => q'^Regelgruppe(n) exportieren^',
    p_pti_display_name => q'^Exportiert die gewählten Regelgruppen^',
    p_pti_description => q'^^'
  );
