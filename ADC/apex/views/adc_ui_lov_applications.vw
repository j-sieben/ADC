create or replace editionable view adc_ui_lov_applications
as 
with params as(
...
comment on table adc_ui_lov_applications is 'LOV view that displays all user defined APEX applications. Application ADC is excluded, unless the user is Administrator';
