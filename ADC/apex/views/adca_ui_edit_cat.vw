...
as 
select cat_id, cat_catg_id, cat_caif_id, cat_name, cat_display_name, cat_description, cat_pl_sql, cat_js, cat_is_editable, cat_raise_recursive, cat_active,
       cap_capt_id_1, cap_display_name_1, cap_description_1, cap_default_1, cap_mandatory_1, cap_active_1,
       cap_capt_id_2, cap_display_name_2, cap_description_2, cap_default_2, cap_mandatory_2, cap_active_2,
       cap_capt_id_3, cap_display_name_3, cap_description_3, cap_default_3, cap_mandatory_3, cap_active_3
  from adc_action_types_v
  left join (
        select cap_cat_id,
               max(decode(cap_sort_seq, 1, cap_capt_id)) cap_capt_id_1,
               ...
               max(decode(cap_sort_seq, 2, cap_capt_id)) cap_capt_id_2,
               ...
               max(decode(cap_sort_seq, 3, cap_capt_id)) cap_capt_id_3,
...
comment on table adca_ui_edit_cat is 'View for APEX page EDIT_CAF';