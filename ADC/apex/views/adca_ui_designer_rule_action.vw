create or replace force view adca_ui_designer_rule_action
as 
select cra_id, cra_crg_id, cra_cru_id, cra_cpi_id, cra_cat_id, cra_on_error,
       cra_param_1, 
...
comment on table adca_ui_designer_rule_action is 'Actual parameter values for a rule action, divided for the visualization types SELEWCT_LIST, TEXT_AREA, TEXT and SWITCH';