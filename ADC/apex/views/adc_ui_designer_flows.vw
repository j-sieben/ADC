create or replace view adc_ui_designer_flows as
with instance_numbers as(
  select dgrm_id, created_cnt, running_cnt, completed_cnt, terminated_cnt, error_cnt, created_cnt + running_cnt + completed_cnt + terminated_cnt + error_cnt as total_cnt
