...
q'[]',
  ...
  utl_text_admin.merge_template(
    p_uttm_name => 'EXPORT_ACTION_TYPE',
    p_uttm_type => 'ADC',
    p_uttm_mode => 'APEX_ACTION_WARN_TYPE',
    p_uttm_text => q'[\CR\]' || 
q'[  adc_admin.merge_apex_action_warn_type(\CR\]' || 
q'[    p_caawt_id => '#CAAWT_ID#',\CR\]' || 
q'[    p_caawt_name => '#CAAWT_NAME#',\CR\]' || 
q'[    p_caawt_description => #CAAWT_DESCRIPTION#,\CR\]' || 
q'[    p_caawt_confirm_message_name => '#CAAWT_CONFIRM_MESSAGE_NAME#',\CR\]' || 
q'[    p_caawt_active  => #CAAWT_ACTIVE#);\CR\]' || 
q'[]',
    p_uttm_log_text => q'[]',
    p_uttm_log_severity => 70
  );
...
q'[\CR\]' || 
q'[  -- APEX_ACTION WARN TYPES#APEX_ACTION_WARN_TYPES#\CR\]' || 
q'[  commit;\CR\]' || 
q'[end;\CR\]' || 
q'[/\CR\]' || 
q'[\CR\]' || 
