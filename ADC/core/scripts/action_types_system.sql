...
q'{}',
  ...
  adc_admin.merge_action_type(
    ...
    p_cat_pl_sql => q'{adc_api.register_mandatory('#ITEM#', true, '#PARAM_1#', '#PARAM_2#');}',
...
q'{  de.condes.plugin.adc.show('#SELECTOR#');}',
  ...
  adc_admin.merge_action_type(
    ...
    p_cat_pl_sql => q'{adc_api.register_mandatory('#ITEM#', false, null, '#PARAM_2#');}',
  ...
  adc_admin.merge_action_type(
    ...
    p_cat_description => q'{<p>Legt die aktuell ausgew&auml;hlten Zeilen-IDs im angegebenen Feld ab.</p>\CR\}' || 
q'{}',
    p_cat_pl_sql => q'{}',
  ...
  adc_admin.merge_action_parameter(
    ...
    p_cap_sort_seq => 1,
    p_cap_default => q'{}',
    p_cap_description => q'{<p>Name des Seitenelements, in das die Auswahl des IG gespeichert werden soll.</p>\CR\}' || 
q'{}',
    p_cap_display_name => '',
    p_cap_mandatory => adc_util.C_TRUE,
    p_cap_active => adc_util.C_TRUE);
  ...
  adc_admin.merge_action_parameter(
    ...
    p_cap_sort_seq => 2,
    p_cap_default => q'{1}',
    p_cap_description => q'{<p>1- basierte Ordinalzahl der Spalte, die im hinterlegten Element abgelegt werden soll. Die Reihenfolge richtet sich nach der Reihenfolge auf der APEX-Anwendungsseite.</p>\CR\}' || 
q'{}',
  ...
  adc_admin.merge_action_parameter(
    ...
    p_cap_sort_seq => 1,
    p_cap_default => q'{}',
    p_cap_description => q'{<p>Komma-separierte Liste von Elementnamen oder CSS-Klassen, die die Felder identifizieren, die zu einer Gruppe zusammengefasst werden. Innerhalb dieser Gruppe muss beim Pr&uuml;fen der Werte genau ein Feld einen NOT NULL-Wert besitzen.<br />\CR\}' || 
...
q'{}',
  ...
  adc_admin.merge_action_parameter(
    ...
    p_cap_sort_seq => 2,
    p_cap_default => q'{}',
    p_cap_description => q'{<p>Medlungsname, der ausgegeben werden soll, falls die Pr&uuml;fung misslingt. Muss ein PIT-Meldungsname sein, in der Form MSG.&lt;Meldungsname&gt;</p>\CR\}' || 
q'{}',
