...
begin
  ...
  param_admin.edit_parameter(
    ...
    p_par_string_value => q'^merge_adc_action_types_system.sql^'
  );

  param_admin.edit_parameter(
    p_par_id => 'ADC_EMBED_RULE_GROUPS',
    p_par_pgr_id => 'ADC',
    p_par_description => 'When exporting rule groups along with the application, it is possible to integrate the rule groups as supporting objects. If FALSE, application and rule groups are exported seperately in a ZIP file',
  ...
  param_admin.edit_parameter(
    ...
    p_par_string_value => q'^{title:#PARAM_2#,modern:true,returnFocusTo:#ITEM#,confirm:true,type:dialog}^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'ADC',
    p_par_description => 'apex.message.showDialog.options objekt adjusting settings for the dialog',
    p_par_string_value => q'^{title:#PARAM_2#,modern:true,returnFocusTo:#ITEM#,style:error,dialogType:dialog}^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'ADC',
    p_par_description => 'apex.message.showDialog.options objekt adjusting settings for the dialog',
    p_par_string_value => q'^{title:#PARAM_2#,modern:true,returnFocusTo:#ITEM#,isPopup:true,style:information,dialogType:dialog}^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'ADC',
    p_par_description => 'apex.message.showDialog.options objekt adjusting settings for the dialog',
    p_par_string_value => q'^{title:#PARAM_2#,modern:true,returnFocusTo:#ITEM#,style:success,dialogType:success}^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'ADC',
    p_par_description => 'apex.message.showDialog.options objekt adjusting settings for the dialog',
    p_par_string_value => q'^{title:#PARAM_2#,modern:true,returnFocusTo:#ITEM#,style:warning,dialogType:dialog}^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_string_value => q'^f#APP_ID#_dynamic.sql^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_string_value => q'^rule_groups_#APP_ALIAS#.zip^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_string_value => q'^merge_rule_group_#CRG_FILE_NAME#.sql^'
  );
  ...
  param_admin.edit_parameter(
    ...
    p_par_string_value => q'^merge_adc_action_types_#CATO#.sql^'
  );

  -- Local parameters

  
  param_admin.harmonize_parameter_group('ADC');
