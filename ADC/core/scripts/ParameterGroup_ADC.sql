begin
  ...
  param_admin.edit_parameter(
    ...
    p_par_pgr_id => 'ADC',
    p_par_description => 'If TRUE integrate the rule groups as supporting objects. If FALSE, application export and rule groups are exported seperately in a ZIP file',
