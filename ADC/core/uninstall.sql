  ...
  cursor delete_object_cur is
          select object_name name, object_type type
           ...
           where (object_name in (
                 ...
                 'ADC_PARAM_LOV_APEX_ACTION', 'ADC_PARAM_LOV_PAGE_ITEM', 'ADC_PARAM_LOV_PIT_MESSAGE', 'ADC_PARAM_LOV_SEQUENCE', 'ADC_PARAM_LOV_STRING_ON_PARAMETER', 'ADC_PARAM_LOV_SUBMIT_TYPE', 'ADC_ACTION_TYPE_OWNERS_V', -- Views
