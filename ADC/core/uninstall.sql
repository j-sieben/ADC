  ...
  cursor delete_object_cur is
          select object_name name, object_type type
           ...
           where (object_name in (
                 'ADC_BASIC', 'ADC', -- Typen
                 'ADC_ADMIN', 'ADC_INTERNAL', 'ADC_UTIL', 'ADC_API', 'ADC_APEX_ACTION',
                 'ADC_ACTIONS', 'ADC_RECURSION_STACK', 'ADC_PAGE_STATE', 'ADC_PARAMETER', 'ADC_RESPONSE',-- Packages
                 'ADC_RULE_GROUP_STATUS', 'ADC_BL_PAGE_ITEMS', 'ADC_BL_PAGE_TARGETS', 'ADC_ACTION_PARAM_VISUAL_TYPES_V',
                 ...
                 'ADC_APEX_ACTION_TYPES_V', 'ADC_APEX_ACTIONS_V', 'ADC_PAGE_ITEM_TYPES_V', 'ADC_ACTION_TYPE_OWNERS_V',
                 'ADC_PARAM_LOV_EVENT', 'ADC_PARAM_LOV_FREE_PAGE_ITEMS', 'ADC_PARAM_LOV_INPUT_FIELDS',
                 'ADC_PARAM_LOV_ITEM_STATUS', 'ADC_PARAM_LOV_PAGE_ITEM', 'ADC_PARAM_LOV_PIT_MESSAGE',
                 'ADC_PARAM_LOV_SEQUENCE', 'ADC_PARAM_LOV_STRING_ON_PARAMETER', 'ADC_PARAM_LOV_SUBMIT_TYPE', -- Views
