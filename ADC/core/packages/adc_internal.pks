...
as
  ...
  /** 
    Package: ADC_INTERNAL 
             ...
             ADC responses to a dynamic request::
               ...
               The flow is that all page state values are provided to a decision table that is stored in ADC_RULE_GROUP.DECISION_TABLE
               ...
               Upon completion, the JavaScript answer stack is serialized into a <script> element and passed back to the calling environment.
  ...
  /* <adc_api.register_item> */
  procedure register_item(
    p_cpi_id in varchar2,
    p_allow_recursion in adc_util.flag_type default adc_util.C_TRUE);


  /* <adc_api.register_mandatory> */
