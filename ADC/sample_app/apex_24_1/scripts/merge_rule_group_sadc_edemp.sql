...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(303),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 9,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(305),
    p_cru_crg_id => adc_config.map_id(303),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(344),
    p_cra_cru_id => adc_config.map_id(305),
    p_cra_crg_id => adc_config.map_id(303),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(303));
