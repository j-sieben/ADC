...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(953),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 19,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(955),
    p_cru_crg_id => adc_config.map_id(953),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(957),
    p_cra_cru_id => adc_config.map_id(955),
    p_cra_crg_id => adc_config.map_id(953),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(959),
    p_cra_cru_id => adc_config.map_id(955),
    p_cra_crg_id => adc_config.map_id(953),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(961),
    p_cru_crg_id => adc_config.map_id(953),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(963),
    p_cra_cru_id => adc_config.map_id(961),
    p_cra_crg_id => adc_config.map_id(953),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(965),
    p_cru_crg_id => adc_config.map_id(953),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(967),
    p_cra_cru_id => adc_config.map_id(965),
    p_cra_crg_id => adc_config.map_id(953),
    p_cra_cpi_id => 'P19_EMP_COMMISSION_PCT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(969),
    p_cra_cru_id => adc_config.map_id(965),
    p_cra_crg_id => adc_config.map_id(953),
    p_cra_cpi_id => 'P19_EMP_COMMISSION_PCT',
  ...
  adc_config.propagate_rule_change(adc_config.map_id(953));
