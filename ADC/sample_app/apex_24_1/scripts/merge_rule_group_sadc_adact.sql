...
begin
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(187),
    p_cru_crg_id => adc_admin.map_id(185),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(189),
    p_cra_cru_id => adc_admin.map_id(187),
    p_cra_crg_id => adc_admin.map_id(185),
  ...
  adc_admin.merge_apex_action(    
    p_caa_id => adc_admin.map_id(195),
    p_caa_crg_id => adc_admin.map_id(185),
  ...
  adc_admin.merge_apex_action_item(
    p_caai_caa_id => adc_admin.map_id(195),
    p_caai_cpi_crg_id => adc_admin.map_id(185),
    p_caai_cpi_id => 'B8_EDIT_EMP',
    p_caai_active => adc_util.C_TRUE);



  adc_admin.propagate_rule_change(adc_admin.map_id(185));
