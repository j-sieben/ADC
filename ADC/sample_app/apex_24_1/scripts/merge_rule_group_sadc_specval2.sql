...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(473),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 18,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(475),
    p_cru_crg_id => adc_config.map_id(473),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(477),
    p_cra_cru_id => adc_config.map_id(475),
    p_cra_crg_id => adc_config.map_id(473),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(479),
    p_cru_crg_id => adc_config.map_id(473),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(481),
    p_cra_cru_id => adc_config.map_id(479),
    p_cra_crg_id => adc_config.map_id(473),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(473));
