...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(237),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 5,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(239),
    p_cru_crg_id => adc_config.map_id(237),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(241),
    p_cra_cru_id => adc_config.map_id(239),
    p_cra_crg_id => adc_config.map_id(237),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(243),
    p_cru_crg_id => adc_config.map_id(237),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(245),
    p_cra_cru_id => adc_config.map_id(243),
    p_cra_crg_id => adc_config.map_id(237),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(247),
    p_cru_crg_id => adc_config.map_id(237),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(249),
    p_cra_cru_id => adc_config.map_id(247),
    p_cra_crg_id => adc_config.map_id(237),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(237));
