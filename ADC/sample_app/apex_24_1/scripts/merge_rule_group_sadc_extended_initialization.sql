...
begin
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(309),
    p_cru_crg_id => adc_admin.map_id(307),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(311),
    p_cra_cru_id => adc_admin.map_id(309),
    p_cra_crg_id => adc_admin.map_id(307),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(315),
    p_cra_cru_id => adc_admin.map_id(313),
    p_cra_crg_id => adc_admin.map_id(307),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(319),
    p_cra_cru_id => adc_admin.map_id(317),
    p_cra_crg_id => adc_admin.map_id(307),
    p_cra_cpi_id => 'P16_EMP_COMMISSION_PCT',
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(307));
