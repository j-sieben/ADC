...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(307),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 16,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(309),
    p_cru_crg_id => adc_config.map_id(307),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(311),
    p_cra_cru_id => adc_config.map_id(309),
    p_cra_crg_id => adc_config.map_id(307),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(313),
    p_cru_crg_id => adc_config.map_id(307),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(315),
    p_cra_cru_id => adc_config.map_id(313),
    p_cra_crg_id => adc_config.map_id(307),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(317),
    p_cru_crg_id => adc_config.map_id(307),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(319),
    p_cra_cru_id => adc_config.map_id(317),
    p_cra_crg_id => adc_config.map_id(307),
    p_cra_cpi_id => 'P16_EMP_COMMISSION_PCT',
  ...
  adc_config.propagate_rule_change(adc_config.map_id(307));
