...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(325),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 99,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(327),
    p_cru_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(329),
    p_cra_cru_id => adc_config.map_id(327),
    p_cra_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(331),
    p_cru_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(333),
    p_cra_cru_id => adc_config.map_id(331),
    p_cra_crg_id => adc_config.map_id(325),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(335),
    p_cru_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(337),
    p_cra_cru_id => adc_config.map_id(335),
    p_cra_crg_id => adc_config.map_id(325),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(339),
    p_cru_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(341),
    p_cra_cru_id => adc_config.map_id(339),
    p_cra_crg_id => adc_config.map_id(325),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(343),
    p_cru_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(345),
    p_cra_cru_id => adc_config.map_id(343),
    p_cra_crg_id => adc_config.map_id(325),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(347),
    p_cru_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(349),
    p_cra_cru_id => adc_config.map_id(347),
    p_cra_crg_id => adc_config.map_id(325),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(351),
    p_cra_cru_id => adc_config.map_id(347),
    p_cra_crg_id => adc_config.map_id(325),
    p_cra_cpi_id => 'P99_LAST_NAME',
    p_cra_cat_id => 'SET_ITEM',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(353),
    p_cru_crg_id => adc_config.map_id(325),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(355),
    p_cra_cru_id => adc_config.map_id(353),
    p_cra_crg_id => adc_config.map_id(325),
    p_cra_cpi_id => 'DOCUMENT',
    p_cra_cat_id => 'PLSQL_CODE',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(357),
    p_cra_cru_id => adc_config.map_id(353),
    p_cra_crg_id => adc_config.map_id(325),
    p_cra_cpi_id => 'P99_LAST_NAME',
    p_cra_cat_id => 'SET_ITEM',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(359),
    p_cra_cru_id => adc_config.map_id(353),
    p_cra_crg_id => adc_config.map_id(325),
    p_cra_cpi_id => 'P99_EMAIL',
    p_cra_cat_id => 'SET_ITEM',
  ...
  adc_config.propagate_rule_change(adc_config.map_id(325));
