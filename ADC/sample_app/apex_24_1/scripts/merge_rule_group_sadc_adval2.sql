...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(251),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 6,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(253),
    p_cru_crg_id => adc_config.map_id(251),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(255),
    p_cra_cru_id => adc_config.map_id(253),
    p_cra_crg_id => adc_config.map_id(251),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(257),
    p_cru_crg_id => adc_config.map_id(251),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(259),
    p_cra_cru_id => adc_config.map_id(257),
    p_cra_crg_id => adc_config.map_id(251),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(261),
    p_cru_crg_id => adc_config.map_id(251),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(263),
    p_cra_cru_id => adc_config.map_id(261),
    p_cra_crg_id => adc_config.map_id(251),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(251));
