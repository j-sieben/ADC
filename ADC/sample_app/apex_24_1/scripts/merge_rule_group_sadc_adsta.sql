...
begin
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(225),
    p_cra_cru_id => adc_config.map_id(221),
    p_cra_crg_id => adc_config.map_id(219),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(227),
    p_cru_crg_id => adc_config.map_id(219),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(229),
    p_cra_cru_id => adc_config.map_id(227),
    p_cra_crg_id => adc_config.map_id(219),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(231),
    p_cru_crg_id => adc_config.map_id(219),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(233),
    p_cra_cru_id => adc_config.map_id(231),
    p_cra_crg_id => adc_config.map_id(219),
    p_cra_cpi_id => 'P7_EMP_COMMISSION_PCT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(363),
    p_cra_cru_id => adc_config.map_id(231),
    p_cra_crg_id => adc_config.map_id(219),
    p_cra_cpi_id => 'P7_EMP_COMMISSION_PCT',
