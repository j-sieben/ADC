...
begin
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(229),
    p_cra_cru_id => adc_admin.map_id(227),
    p_cra_crg_id => adc_admin.map_id(219),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(233),
    p_cra_cru_id => adc_admin.map_id(231),
    p_cra_crg_id => adc_admin.map_id(219),
    p_cra_cpi_id => 'P7_EMP_COMMISSION_PCT',
