...
begin
  ...
  adc_admin.merge_rule(
    p_cru_id => adc_admin.map_id(267),
    p_cru_crg_id => adc_admin.map_id(265),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(269),
    p_cra_cru_id => adc_admin.map_id(267),
    p_cra_crg_id => adc_admin.map_id(265),
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(287),
    p_cra_cru_id => adc_admin.map_id(285),
    p_cra_crg_id => adc_admin.map_id(265),
    p_cra_cpi_id => 'DOCUMENT',
  ...
  adc_admin.merge_rule_action(
    p_cra_id => adc_admin.map_id(293),
    p_cra_cru_id => adc_admin.map_id(291),
    p_cra_crg_id => adc_admin.map_id(265),
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(265));
