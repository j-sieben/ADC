...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(265),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 50,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(267),
    p_cru_crg_id => adc_config.map_id(265),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(269),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(271),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(273),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(275),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(277),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(279),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(281),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(283),
    p_cra_cru_id => adc_config.map_id(267),
    p_cra_crg_id => adc_config.map_id(265),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(285),
    p_cru_crg_id => adc_config.map_id(265),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(287),
    p_cra_cru_id => adc_config.map_id(285),
    p_cra_crg_id => adc_config.map_id(265),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(289),
    p_cra_cru_id => adc_config.map_id(285),
    p_cra_crg_id => adc_config.map_id(265),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(291),
    p_cru_crg_id => adc_config.map_id(265),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(293),
    p_cra_cru_id => adc_config.map_id(291),
    p_cra_crg_id => adc_config.map_id(265),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(265));
