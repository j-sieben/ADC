...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(197),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 4,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(199),
    p_cru_crg_id => adc_config.map_id(197),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(201),
    p_cra_cru_id => adc_config.map_id(199),
    p_cra_crg_id => adc_config.map_id(197),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(203),
    p_cra_cru_id => adc_config.map_id(199),
    p_cra_crg_id => adc_config.map_id(197),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(197));
