...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(971),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 20,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(973),
    p_cru_crg_id => adc_config.map_id(971),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(989),
    p_cra_cru_id => adc_config.map_id(973),
    p_cra_crg_id => adc_config.map_id(971),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(975),
    p_cra_cru_id => adc_config.map_id(973),
    p_cra_crg_id => adc_config.map_id(971),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(977),
    p_cra_cru_id => adc_config.map_id(973),
    p_cra_crg_id => adc_config.map_id(971),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(979),
    p_cru_crg_id => adc_config.map_id(971),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(981),
    p_cra_cru_id => adc_config.map_id(979),
    p_cra_crg_id => adc_config.map_id(971),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(983),
    p_cru_crg_id => adc_config.map_id(971),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(985),
    p_cra_cru_id => adc_config.map_id(983),
    p_cra_crg_id => adc_config.map_id(971),
    p_cra_cpi_id => 'P20_EMP_COMMISSION_PCT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(987),
    p_cra_cru_id => adc_config.map_id(983),
    p_cra_crg_id => adc_config.map_id(971),
    p_cra_cpi_id => 'P20_EMP_COMMISSION_PCT',
  ...
  adc_config.propagate_rule_change(adc_config.map_id(971));
