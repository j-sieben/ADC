...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(117),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 7,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(119),
    p_cru_crg_id => adc_config.map_id(117),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(121),
    p_cra_cru_id => adc_config.map_id(119),
    p_cra_crg_id => adc_config.map_id(117),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(123),
    p_cra_cru_id => adc_config.map_id(119),
    p_cra_crg_id => adc_config.map_id(117),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(125),
    p_cru_crg_id => adc_config.map_id(117),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(127),
    p_cra_cru_id => adc_config.map_id(125),
    p_cra_crg_id => adc_config.map_id(117),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(129),
    p_cru_crg_id => adc_config.map_id(117),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(131),
    p_cra_cru_id => adc_config.map_id(129),
    p_cra_crg_id => adc_config.map_id(117),
    p_cra_cpi_id => 'P7_EMP_COMMISSION_PCT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(133),
    p_cra_cru_id => adc_config.map_id(129),
    p_cra_crg_id => adc_config.map_id(117),
    p_cra_cpi_id => 'P7_EMP_COMMISSION_PCT',
  ...
  adc_config.propagate_rule_change(adc_config.map_id(117));
