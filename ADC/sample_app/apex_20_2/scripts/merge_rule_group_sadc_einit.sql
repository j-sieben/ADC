...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(205),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 16,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(207),
    p_cru_crg_id => adc_config.map_id(205),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(209),
    p_cra_cru_id => adc_config.map_id(207),
    p_cra_crg_id => adc_config.map_id(205),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(211),
    p_cru_crg_id => adc_config.map_id(205),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(213),
    p_cra_cru_id => adc_config.map_id(211),
    p_cra_crg_id => adc_config.map_id(205),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(215),
    p_cru_crg_id => adc_config.map_id(205),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(217),
    p_cra_cru_id => adc_config.map_id(215),
    p_cra_crg_id => adc_config.map_id(205),
    p_cra_cpi_id => 'P16_EMP_COMMISSION_PCT',
  ...
  adc_config.propagate_rule_change(adc_config.map_id(205));
