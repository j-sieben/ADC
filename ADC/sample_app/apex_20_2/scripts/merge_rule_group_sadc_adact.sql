...
begin
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(85),
    p_cru_crg_id => adc_config.map_id(83),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(87),
    p_cra_cru_id => adc_config.map_id(85),
    p_cra_crg_id => adc_config.map_id(83),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(91),
    p_cra_cru_id => adc_config.map_id(89),
    p_cra_crg_id => adc_config.map_id(83),
  ...
  adc_config.merge_apex_action(    
    p_caa_id => adc_config.map_id(93),
    p_caa_crg_id => adc_config.map_id(83),
  ...
  adc_config.merge_apex_action_item(
    p_caai_caa_id => adc_config.map_id(93),
    p_caai_cpi_crg_id => adc_config.map_id(83),
    p_caai_cpi_id => 'B8_EDIT_EMP',
    p_caai_active => adc_util.C_TRUE);



  adc_config.propagate_rule_change(adc_config.map_id(83));
