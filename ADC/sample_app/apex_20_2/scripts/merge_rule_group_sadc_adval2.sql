...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(149),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 6,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(151),
    p_cru_crg_id => adc_config.map_id(149),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(153),
    p_cra_cru_id => adc_config.map_id(151),
    p_cra_crg_id => adc_config.map_id(149),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(155),
    p_cru_crg_id => adc_config.map_id(149),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(157),
    p_cra_cru_id => adc_config.map_id(155),
    p_cra_crg_id => adc_config.map_id(149),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(159),
    p_cru_crg_id => adc_config.map_id(149),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(161),
    p_cra_cru_id => adc_config.map_id(159),
    p_cra_crg_id => adc_config.map_id(149),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(149));
