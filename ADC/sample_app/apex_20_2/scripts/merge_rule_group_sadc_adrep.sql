...
begin
  ...
  adc_admin.merge_rule(
    ...
    p_cru_crg_id => adc_admin.map_id(103),
  ...
  adc_admin.merge_rule_action(
    ...
    p_cra_crg_id => adc_admin.map_id(103),
  ...
  adc_admin.merge_rule_action(
    ...
    p_cra_cru_id => adc_admin.map_id(113),
    p_cra_crg_id => adc_admin.map_id(103),
  ...
  adc_admin.propagate_rule_change(adc_admin.map_id(103));
