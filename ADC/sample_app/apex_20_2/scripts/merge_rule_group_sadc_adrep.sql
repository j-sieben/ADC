...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(103),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 10,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(105),
    p_cru_crg_id => adc_config.map_id(103),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(107),
    p_cra_cru_id => adc_config.map_id(105),
    p_cra_crg_id => adc_config.map_id(103),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(109),
    p_cra_cru_id => adc_config.map_id(105),
    p_cra_crg_id => adc_config.map_id(103),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(111),
    p_cra_cru_id => adc_config.map_id(105),
    p_cra_crg_id => adc_config.map_id(103),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(113),
    p_cru_crg_id => adc_config.map_id(103),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(115),
    p_cra_cru_id => adc_config.map_id(113),
    p_cra_crg_id => adc_config.map_id(103),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(103));
