...
begin
  ...
  adc_config.merge_rule_group(
    p_crg_id => adc_config.map_id(163),
    p_crg_app_id => l_app_id,
    p_crg_page_id => 50,
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(165),
    p_cru_crg_id => adc_config.map_id(163),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(167),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(169),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(171),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(173),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(175),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(177),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(179),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(181),
    p_cra_cru_id => adc_config.map_id(165),
    p_cra_crg_id => adc_config.map_id(163),
  ...
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(183),
    p_cru_crg_id => adc_config.map_id(163),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(185),
    p_cra_cru_id => adc_config.map_id(183),
    p_cra_crg_id => adc_config.map_id(163),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(187),
    p_cra_cru_id => adc_config.map_id(183),
    p_cra_crg_id => adc_config.map_id(163),
    p_cra_cpi_id => 'DOCUMENT',
    ...
    p_cra_active => adc_util.C_TRUE);
  adc_config.merge_rule(
    p_cru_id => adc_config.map_id(189),
    p_cru_crg_id => adc_config.map_id(163),
  ...
  adc_config.merge_rule_action(
    p_cra_id => adc_config.map_id(191),
    p_cra_cru_id => adc_config.map_id(189),
    p_cra_crg_id => adc_config.map_id(163),
  ...
  adc_config.propagate_rule_change(adc_config.map_id(163));
